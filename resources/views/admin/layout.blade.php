    ...
    <nav class="navbar navbar-expand-sm bg-warning navbar-light">
        <ul class="navbar-nav ">
            <li class="nav-item pl-3">
                <a class="nav-link" href="{{route('admin_dashboard')}}"><b>Admin Name</b> </a>
            </li>
            <li class="nav-item pl-3">
                <a class="nav-link" href="{{route('admin_products')}}"><b>Products</b> </a>
            </li>
            <li class="nav-item pl-3">
                <a class="nav-link" href="{{route('admin_employees')}}"><b>Employees</b></a>
            </li>
            <li class="nav-item pl-3">
